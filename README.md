...
```
## Create a task
We will see now how to create a task. To start simple, we will create a task without logging and ML flow.
We will see later how to create a true ML task with tracking convergence and other parameters.
